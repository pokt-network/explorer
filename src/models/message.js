...
const MessageTypes = {
  ...
  NodeStake: {
    ...
    object: {
      name: "Amount",
      value: (msgValue) => Utils.toPOKT(msgValue.value),
    },
    fee: { name: "Tx Fee", value: (msgValue) => Utils.toPOKT(msgValue.amount) },
    memo: { name: "Tx Memo", value: (msgValue) => msgValue },
    result: {
  ...
  Claim: {
    ...
    subject: {
      name: "App",
      value: (msgValue) => msgValue.header.app_public_key,
    },
  ...
  Proof: {
    ...
    actor: {
      name: "Servicer",
      value: (msgValue) => msgValue.leaf.value.servicer_pub_key,
    },
    subject: {
      name: "App",
      value: (msgValue) => msgValue.leaf.value.aat.app_pub_key,
    },
    object: {
      name: "Blockchain",
      value: (msgValue) => msgValue.leaf.value.blockchain,
    },
    fee: { name: "Tx Fee", value: (msgValue) => Utils.toPOKT(msgValue.amount) },
    memo: { name: "Tx Memo", value: (msgValue) => msgValue },
    result: {
